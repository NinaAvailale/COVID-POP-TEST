...
function ydot = fsimu(T,theta,xdata,par_tau,Inital_Middle)
...
HE(1) = Inital_Middle.HE;
HA(1) = Inital_Middle.HA;
HP(1) = Inital_Middle.HP;
HI(1) = Inital_Middle.HI;


HS(1) = Inital_Middle.HS;
HN(1) = Ptonghua; %susceptible
HC(1) = 0;
HT(1) = 0;
DHC(1) = 0;
DHT(1) = 0;

HR(1) = Inital_Middle.HR;
HQ(1) = Inital_Middle.HQ;
